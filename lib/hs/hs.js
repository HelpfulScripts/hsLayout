 ...
 * @description provides for a basic configuration mechanism and
 ...
 */
        return function cfgSave(file) {
            var result = objCfgSave(obj);  
            $http.post(file, JSON.stringify(result));
        };
    }
...
angular.module('hs').factory('HsObject', function HsObject(){ 
	...
	return function(type, name, parent) {
        ...
        obj.getName = function getName() { return name || "undefined"; };
